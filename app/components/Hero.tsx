...
const Hero = ({
  name = "Aakash",
  text = "I built Friendly web experiences and help others become confident,modern developers",
}) => {
  return (
    <header className="text-center py-20 px-4 bg-gray-900 text-white transition-colors duration-300">
      ...
      <div className="flex justify-center gap-4">
        <Link
          to="/projects"
          className="bg-blue-600 py-2 px-6 rounded text-white hover:bg-blue-700 transition "
        >
          View Projects
        </Link>
        <Link
